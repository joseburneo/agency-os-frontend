...
const ROADMAP_SEED: Record<string, RoadmapItem[]> = {
  ...
  "pepe-rodr-guez-de-vera": [
    ...
    { id: "p3", date: "2026-08-07", status: "in_progress", kind: "decision", title: "Vuestra decisión · plan de $1,750/mes", detail: "El equipo valora el plan básico: una campaña por mes, un país a la vez, con todo lo de abajo incluido. Si usamos vuestra suscripción de Smartlead, lo descontamos del precio. Las dudas que salgan el viernes las respondemos por correo el mismo día.", tags: ["comercial"] },
    { id: "p4", date: "", status: "planned", kind: "build", title: "Semana 1 · Setup y assessment de deliverability", detail: "Revisamos vuestros ~10 dominios contra los spam houses, montamos monitoreo con alertas, plan de rotación con dominios de reserva y la política de privacidad GDPR lista para publicar. Conectamos Smartlead y el API hacia vuestro HubSpot.", tags: ["deliverability", "setup"] },
    { id: "p5", date: "", status: "planned", kind: "build", title: "Semana 2 · Alemania: lista investigada y calificada", detail: "Los contactos del oeste de Alemania investigados uno a uno por nuestros agentes (web y LinkedIn) y reducidos a la lista corta. Solo entonces se compran los correos, verificados dos veces para que no haya bounces.", tags: ["alemania", "lista"] },
    { id: "p6", date: "", status: "planned", kind: "launch", title: "Semana 3 · Emails únicos y lanzamiento", detail: "Un email por contacto, escrito con el contexto de cada casa, con control de calidad multi-agente. Todos visibles aquí, en vuestras listas, antes de salir. Envío con cuentas calentadas, mitad Google y mitad Microsoft.", tags: ["copy", "launch"] },
    { id: "p7", date: "", status: "planned", kind: "milestone", title: "Semana 4+ · Respuestas y agenda para el viaje", detail: "Cada positivo se crea como contacto en vuestro HubSpot por API, las respuestas salen desde el hilo correcto con firma HTML y la cadencia de seguimiento no deja escapar ninguna ficha. Objetivo: la agenda de septiembre cargada antes de volar.", tags: ["respuestas", "reuniones"] },
    { id: "p8", date: "", status: "planned", kind: "milestone", title: "Cada mes · un país del calendario", detail: "El mismo ciclo, sincronizado con vuestros viajes: Suiza, Francia, Portugal y los que vengan. Vosotros elegís el orden; nosotros llegamos antes que el avión.", tags: ["cadencia"] },
    { id: "p9", date: "2027-01-05", status: "planned", kind: "milestone", title: "Enero · el proyecto completo", detail: "Cuando amplíes presupuesto: base de datos SQL propia, servidor en Alemania con los scripts, dos países al mes, gestión completa de respuestas y el lead magnet de maridajes por menú que salió de tu idea en la llamada. La infraestructura queda vuestra.", tags: ["enero", "upgrade"] },
  ],
  "arco-irish": [
