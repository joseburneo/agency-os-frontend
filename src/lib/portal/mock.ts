...
const ARCO: WorkspaceData = {
  ...
  leads: [
    { id: "c1", listId: "l1", name: "Pritesh Tiwari", role: "Founder & Chief Data Scientist", company: "DSW", sector: "Software / SaaS", domain: "datasciencewizards.ai", emailDisplay: "p••••@datasciencewizards.ai", linkedin: true, hasEmail: true, hasDraft: true },
    { id: "c2", listId: "l1", name: "Paul McCarthy", role: "Founder, Board Member", company: "Snapfix", sector: "Software / SaaS", domain: "snapfix.com", emailDisplay: "p••••@snapfix.com", linkedin: true, hasEmail: true, hasDraft: true },
    { id: "c3", listId: "l1", name: "Brian Thompson", role: "Founder, Managing Director", company: "OutForm Consulting", sector: "Accounting / advisory", domain: "outformconsulting.com", emailDisplay: "b••••@outformconsulting.com", linkedin: true, hasEmail: true, hasDraft: true },
    { id: "c4", listId: "l1", name: "Stephen Keogh", role: "Managing Partner", company: "MHP Sellors", sector: "Law / legal", domain: "mhpsellors.ie", emailDisplay: "", linkedin: true, hasEmail: false, hasDraft: false },
    { id: "c5", listId: "l1", name: "John Wallace", role: "Managing Director", company: "Sorensen Civil Engineering", sector: "Engineering", domain: "sorensen.ie", emailDisplay: "j••••@sorensen.ie", linkedin: true, hasEmail: true, hasDraft: true },
    { id: "c6", listId: "l1", name: "Michael York", role: "Chief Executive Officer", company: "GDHF", sector: "Financial services", domain: "gdhf-lease.com", emailDisplay: "m••••@gdhf-lease.com", linkedin: true, hasEmail: true, hasDraft: true },
    { id: "c7", listId: "l1", name: "Emmett Kilduff", role: "Founder & Chairman", company: "Eagle Alpha", sector: "Technology / data", domain: "eaglealpha.com", emailDisplay: "e••••@eaglealpha.com", linkedin: true, hasEmail: true, hasDraft: true },
    { id: "c8", listId: "l1", name: "Jim Hughes", role: "Chief Executive Officer", company: "Innovate", sector: "IT services", domain: "innovate.ie", emailDisplay: "j••••@innovate.ie", linkedin: true, hasEmail: true, hasDraft: true },
    { id: "c9", listId: "l1", name: "Wayne Crosbie", role: "CEO / Managing Director", company: "Crosbie Group", sector: "Engineering", domain: "crosbie.ie", emailDisplay: "w••••@crosbie.ie", linkedin: true, hasEmail: true, hasDraft: true },
    { id: "c10", listId: "l2", name: "Aoife Brennan", role: "Head of People", company: "Fenergo", sector: "Software / SaaS", domain: "fenergo.com", emailDisplay: "a••••@fenergo.com", linkedin: true, hasEmail: true, hasDraft: true },
    { id: "c11", listId: "l2", name: "Colm Byrne", role: "HR Director", company: "Kingspan", sector: "Manufacturing", domain: "kingspan.com", emailDisplay: "c••••@kingspan.com", linkedin: true, hasEmail: true, hasDraft: false },
    { id: "c12", listId: "l4", name: "Sharon Kelly", role: "Chief Executive", company: "Version 1", sector: "IT services", domain: "version1.com", emailDisplay: "s••••@version1.com", linkedin: true, hasEmail: true, hasDraft: true },
  ],
  emailCampaigns: [
...
const LUXVANCE: WorkspaceData = {
  ...
  leads: [
    { id: "x1", listId: "ll1", name: "Guy Kashtan", role: "VP of Business Development", company: "Odeeo", sector: "AdTech", domain: "odeeo.io", emailDisplay: "g••••@odeeo.io", linkedin: true, hasEmail: true, hasDraft: true },
    { id: "x2", listId: "ll1", name: "Rohan Premnath", role: "Business Development Director", company: "AudioStack", sector: "AI / audio", domain: "audiostack.ai", emailDisplay: "r••••@audiostack.ai", linkedin: true, hasEmail: true, hasDraft: true },
    { id: "x3", listId: "ll2", name: "Hugo Dessi", role: "Head of Sales", company: "SaleCycle", sector: "MarTech", domain: "salecycle.com", emailDisplay: "h••••@salecycle.com", linkedin: true, hasEmail: true, hasDraft: false },
    { id: "x4", listId: "ll2", name: "Daniel Hijazi", role: "Founder & CEO", company: "Micron Agritech", sector: "AgriTech", domain: "micronagritech.com", emailDisplay: "d••••@micronagritech.com", linkedin: true, hasEmail: true, hasDraft: true },
  ],
  emailCampaigns: [
