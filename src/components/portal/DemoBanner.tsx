...
export function DemoBanner({ name }: { name: string }) {
  return (
    <div className="mb-6 flex flex-wrap items-center gap-3 rounded-xl border border-gold/25 bg-gradient-to-r from-gold/[0.08] to-transparent px-4 py-3">
      <span className="grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-gold/15 text-gold-ink">
      ...
      <Link
        ...
        className="inline-flex shrink-0 items-center gap-1.5 rounded-lg bg-gold px-3.5 py-2 text-[12px] font-bold text-ink-inverse transition-colors hover:bg-gold-hi"
      >
